...
Phase 2 clinical trials assess the **safety** and **efficacy** of a new drug or drug combination for a specific medical condition. The main goal is to determine an appropriate dose and treatment regimen for Phase 3 testing. 

Phase 2 trails are further divided into: 

-   Phase 2a: These trials involve fewer patients, typically 100 to 300, and focus on 
    -   **dose-response relationships**: How increasing dosage increments correlates to increase in response, and
    -   **optimal dosing frequency**: The ideal schedule for administering a treatment to achieve the best results while minimizing side effects.
-   Phase 2b: These trials are designed to rigorously test and evaluate the drug's effectiveness in treating, preventing, or diagnosing a disease.

Phase 2 primarily assesses the **therapeutic effectiveness** in a specific patient population to determine if the drug may potentially benefit patients and warrant further study in a phase 3 trial. It is used to assess safety parameters for any adverse events that might have been missed in a particular patient group.
...
-   **Phase 2a**: Involves fewer patients, generally 100-300 patients and focuses on:
    -   **dose-response relationships**: How increasing dosage increments correlates to increase in response, and
    -   **optimal dosing frequency**: The ideal schedule for administering a treatment to achieve the best results while minimizing side effects.
...
are often complex and time consuming with repeated similar workflow steps for each new variation of the trail.
